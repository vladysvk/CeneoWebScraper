...
class Product:
    ...
    def calculate_stats(self):
        ...
        self.stats["recomendations"] = opinions.recomend.value_counts(dropna=False).sort_index().reindex(["Polecam", "Nie polecam", None], fill_value=0)
